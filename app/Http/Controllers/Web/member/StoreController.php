...
use App\Http\Requests\Member\StoreCreateRequest;
use App\Http\Requests\Member\StoreUpdateRequest;
...
class StoreController extends Controller
{
    public function create(Request $request)
    {
        ...
        return Inertia::render('member/store/Create');
    }
    ...
    public function edit(Store $store)
    {
        ...
        return Inertia::render('member/store/Edit', [
            'store' => $store
        ]);
    }
